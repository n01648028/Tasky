...
public class TeamTask {
    ...
    public Team getCreatedBy() { return createdBy; }
    public void setCreatedBy(Team createdBy) { this.createdBy = createdBy; }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        TeamTask task = (TeamTask) o;

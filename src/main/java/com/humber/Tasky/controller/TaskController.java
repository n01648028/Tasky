...
public Task uncompleteTask(@PathVariable String taskId) {
    ...
    public void inviteUserToTask(@PathVariable String taskId, @RequestParam String userId) {
        taskService.inviteUserToTask(taskId, userId);
    }

    @PostMapping("/{taskId}/accept")
    public void acceptTaskInvitation(@PathVariable String taskId, @RequestParam String userId) {
        taskService.acceptTaskInvitation(taskId, userId);
    }
    ...
    public void leaveTask(@PathVariable String taskId, @RequestParam String userId) {
        taskService.leaveTask(taskId, userId);
    }
}